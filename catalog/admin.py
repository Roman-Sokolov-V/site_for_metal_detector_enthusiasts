...
class ComradAdmin(UserAdmin):
    ...
    fieldsets = UserAdmin.fieldsets + (("Additional info", {"fields": ("detector_model",)}),)
    add_fieldsets = UserAdmin.add_fieldsets + (("Additional info", {"fields": ("first_name", "last_name", "detector_model")}),)
...
class FeedbackAdmin(admin.ModelAdmin):
    list_display = ("created_at", "reviewer", "finding", "rating", "comment",)
    list_filter = ("finding", "rating",)
