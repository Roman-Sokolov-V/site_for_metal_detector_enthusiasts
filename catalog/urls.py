...
urlpatterns = [
    ...
    path("comrades/<int:pk>/update/", UserUpdateView.as_view(), name="comrades-update"),
    path("comrades/<int:pk>/delele/", UserDeleteView.as_view(), name="comrades-delete"),
    path(
        "collections/create/", CollectionCreateView.as_view(), name="collections-create"
    ),
    path(
    ...
    path("findings/<int:pk>/", FindingsDetailView.as_view(), name="findings-detail"),
    path("findings/create", FindingsCreateView.as_view(), name="findings-create"),
    path(
        "findings/<int:pk>/update/",
        FindingsUpdateView.as_view(),
        name="findings-update",
    ),
    path(
        "findings/<int:pk>/delele/",
        FindingsDeleteView.as_view(),
